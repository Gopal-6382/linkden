          ...
          <Link className="navbar-brand d-flex align-items-center" to="/">
            <span className="logo-icon me-2">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M12 0C5.373 0 0 5.373 0 12C0 18.627 5.373 24 12 24C18.627 24 24 18.627 24 12C24 5.373 18.627 0 12 0ZM9 17.5H6.5V9.5H9V17.5ZM7.75 8.25C6.7835 8.25 6 7.4665 6 6.5C6 5.5335 6.7835 4.75 7.75 4.75C8.7165 4.75 9.5 5.5335 9.5 6.5C9.5 7.4665 8.7165 8.25 7.75 8.25ZM18 17.5H15.5V13C15.5 11.6193 14.3807 10.5 13 10.5C11.6193 10.5 10.5 11.6193 10.5 13V17.5H8V9.5H10.5V10.765C11.2345 9.9115 12.5265 9.5 13.5 9.5C15.9853 9.5 18 11.5147 18 14V17.5Z" fill="currentColor"/>
              </svg>
            </span>
